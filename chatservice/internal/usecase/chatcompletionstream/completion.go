...
import (
	...
	"github.com/rcdeo/evento-fclx/chatservice/internal/domain/entity"
	"github.com/rcdeo/evento-fclx/chatservice/internal/domain/gateway"
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	if err != nil {
		return nil, errors.New("error creaing assistant message: " + err.Error())
	}
	err = chat.AddMessage(assistant)
	if err != nil {
		return nil, errors.New("error aading new message: " + err.Error())
	}
...
func createdNewChat(input ChatCompletionInputDTO) (*entity.Chat, error) {
